...
This function performs a Quantile Normalization on each sub-group and
batch in the data set. **It therefore requires grouping information**.
See Examples for more information. This approach might perform better
...
'Discrete' normalization in Zhao *et al.* but has been renamed for
