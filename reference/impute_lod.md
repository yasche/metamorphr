...
Replace missing intensity values (`NA`) by what is assumed to be the
detector limit of detection (LoD). It is estimated by dividing the
Feature minimum by the provided denominator, usually 5. See the
...
- div_by:
  ...
  A numeric value that specifies by which number the Feature minimum
  will be divided
...
[LoD on
OmicsForum](https://omicsforum.ca/t/how-to-deal-with-missing-values/75)
