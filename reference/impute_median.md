...
Replace missing intensity values (`NA`) with the Feature median of
non-`NA` values. For example, if a Feature has the measured intensities
`NA, 1, NA, 3, 2` in samples 1-5, the intensities after
`impute_median()` would be `2, 1, 2, 3, 2`.
...
#>  3     3 304.24023 Da 32.86 s   Sample1       5.5  0.55  305. Arachidon… C20H32…
...
#> 10    10 1284.34904 Da 498.94 s Sample1       3    8.32 1285. NA         NA     
#> # ℹ 100 more rows
```
