...
Calculates the mean of the intensity of technical replicates (e.g., if
the same sample was injected multiple times or if multiple workups have
been performed on the same starting material). The function assigns new
sample names by joining either group and replicate name, or if a batch
column is specified group, replicate and batch together with a specified
separator. Due to the nature of the function, sample and feature
metadata columns will be dropped unless they are specified with the
according arguments.
...
#>  1     1 161.10519 Da 26.98 s QC_1             5.33 QC                1     1
#>  2     1 161.10519 Da 26.98 s blank_1          0.6  blank             1     1
#>  3     1 161.10519 Da 26.98 s control_1        3.67 control           1     1
#>  4     1 161.10519 Da 26.98 s treatment_1      5.87 treatment         1     1
#>  5     2 276.13647 Da 27.28 s QC_1             5.67 QC                1     1
#>  6     2 276.13647 Da 27.28 s blank_1          6.5  blank             1     1
#>  7     2 276.13647 Da 27.28 s control_1        4.67 control           1     1
#>  8     2 276.13647 Da 27.28 s treatment_1      3    treatment         1     1
#>  9     3 304.24023 Da 32.86 s QC_1             5.33 QC                1     1
