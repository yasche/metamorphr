...
\$\$\widetilde{x}\_{ij}=\frac{x\_{ij}-\overline{x}\_{i}}{s_i}\cdot
\frac{\overline{x}\_{i}}{s_i}\$\$
...
intensities of feature \\i\\ across all samples and \\{s_i}\\ is the
standard deviation of intensities of feature \\i\\ across all samples.
Note that \\\frac{\overline{x}\_{i}}{s_i} = \frac{{1}}{CV}\\ where CV is
the coefficient of variation across all samples.
[`scale_vast_grouped`](https://yasche.github.io/metamorphr/reference/scale_vast_grouped.md)
is a variation of this function that uses a group-specific coefficient
of variation. In other words, it performs autoscaling
([`scale_auto`](https://yasche.github.io/metamorphr/reference/scale_auto.md))
and divides by the coefficient of variation, thereby reducing the
importance of features with a poor reproducibility.
...
- J. Sun, Y. Xia, *Genes & Diseases* **2024**, *11*, 100979, DOI
