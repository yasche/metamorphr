...
#'
#'
collapse_min <- function(data, group_column, replicate_column, batch_column = NULL, feature_metadata_cols = "Feature", sample_metadata_cols = NULL, separator = "_") {
  group_column_string <- gsub("`$", "", gsub("^`", "", rlang::expr_label(substitute(group_column))))
  replicate_column_string <- gsub("`$", "", gsub("^`", "", rlang::expr_label(substitute(replicate_column))))
  batch_column_string <- gsub("`$", "", gsub("^`", "", rlang::expr_label(substitute(batch_column))))
...
#'
#'
collapse_max <- function(data, group_column, replicate_column, batch_column = NULL, feature_metadata_cols = "Feature", sample_metadata_cols = NULL, separator = "_") {
  group_column_string <- gsub("`$", "", gsub("^`", "", rlang::expr_label(substitute(group_column))))
  replicate_column_string <- gsub("`$", "", gsub("^`", "", rlang::expr_label(substitute(replicate_column))))
  batch_column_string <- gsub("`$", "", gsub("^`", "", rlang::expr_label(substitute(batch_column))))

  collapse_helper(collapse_fn = max, collapse_fn_string = "max", data =  data, feature_metadata_cols, sample_metadata_cols, separator, group_column_string, replicate_column_string, batch_column_string)
}
