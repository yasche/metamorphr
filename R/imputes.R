...
#'
#' @description
#' Replace missing intensity values (`NA`) with the lowest observed intensity. This imputation method is very rudimentary and other methods might provide better results.
#'
...
#'
#' @description
#' Replace missing intensity values (`NA`) with a user-provided value (e.g., 1). This imputation method is very rudimentary and other methods might provide better results.
#'
#' @param data A tidy tibble created by `metamorphr::read_featuretable()`.
