...
#'   \item{Feature}{A label given to each Feature for easier identifiaction. The column of the original feature table that is used to generate the Feature column is specified with the `label_col` argument of `metamorphr::read_featuretable()`.}
